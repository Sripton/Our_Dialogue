...
function Singlecomments({
  ...
  // Анализ
  // При нажатии на reply перерендриается только комменетрий и его Replies
  // console.log("🔁 Rerender SingleComment:", comment.id);
...
function areEqualSinglecomments(prevProps, nextProps) {
  ...
  // Это оптимизация: если абсолютно ничего не изменилось — не запускаем даже isReplyTarget().
  if (
